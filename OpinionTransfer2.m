...
%       newCertainty1, 2: The new certainties of intidivuals 1 and 2
    ...
    newCertainty1 = newCertainty1 - (newCertainty1<0)*newCertainty1 ...
        - (newCertainty1>1)*(newCertainty1-1);
    newCertainty2 = newCertainty2 - (newCertainty2<0)*newCertainty2 ...
        - (newCertainty2>1)*(newCertainty2-1);
